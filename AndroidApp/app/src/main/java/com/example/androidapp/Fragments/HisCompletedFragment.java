...
public class HisCompletedFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_history_completed,
                container, false);
        ...
        historyOrderViewModel.getAllHistorySuccessOrder().observe(getActivity(), new Observer<List<HistoryOrder>>() {
            @Override
